...
const multiplicarExpression = function (a,b){
    return a*b;
};
...
// Llamar algunas funciones para ver sus salidas
despedir(); 
console.log(multiplicarPorDos(5)); 
console.log(esMayorDeEdad(20)); 
console.log(saludarPersonalizado('Diego', 'Gavilan')); 
...
console.log(saludarFlecha('Diego')); 
